...
public interface SuperAdminConstants {
    String MENU="Super admin menu";
    String MAKE_ADMIN="Make admin";
    String MAKE_USER="Make user";
    String MAKE_ACTIVE="Make active";
    String MAKE_BLOCK="Make block";
    String GET_ALL="Get all profile";
    String GET_ALL_ADMIN="Get all admin";
    String GET_ALL_USER="Get all user";
    String GET_BY_CHAT_ID="Get by chatId";
    String ENTERING_ID_FOR_MAKE_ADMIN = "Entering profile id for make admin";
    String ENTERING_ID_FOR_MAKE_USER = "Entering profile id for make user";
    ...
    String NO_ACCEPT = " No accept to create";
